 ...
 * 
 */
var backgroundColour = '#ffdcd6'; //'#fff'; //background colour
var textCredit = '積分 : [NUMBER]'; //credit text display
var textPaid = '付出 : [NUMBER]'; //paid text display
var textWin = '贏取 : [NUMBER]'; //win text display

var gameCredit = 5000; //game credit
var gameTimer = 1800000; //game timer
...
var shareTitle = '骰寶比賽最高分 [SCORE]';//social share score title
var shareMessage = '[SCORE] 這是我在骰寶遊戲上的新高分！立即嘗試!'; //social share score message
